...
Tags: irisnet, porn blocker, nudity blocker, detector, content management, image moderation, moderation ai
...
== Description ==
The Irisnet API Plugin allows you to add AI functionality to WordPress, that can help you to block or blur user content in real-time.
All you need to do is install, configure it and add the necessary code to check the images. 
After that all of the user uploaded images can be blocked, if it does not adhere to your configured rules.

This plugin makes use of the irisnet API to interact with the AI
